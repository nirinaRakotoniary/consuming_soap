 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://www.niri.com/tp7_soa/gen", wsdlLocation = "http://localhost:8080/ws/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://www.niri.com/tp7_soa/gen", "CountriesPortService");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://www.niri.com/tp7_soa/gen", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.niri.com/tp7_soa/gen", "CountriesPortSoap11"), CountriesPort.class, features);
    }
